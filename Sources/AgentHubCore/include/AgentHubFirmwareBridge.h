...
typedef struct {
    ...
    bool recording;
} AgentHubFirmwareSnapshot;

void *agent_hub_firmware_create(void);
void agent_hub_firmware_destroy(void *context);
void agent_hub_firmware_update(void *context, uint32_t now_ms);
...
void agent_hub_firmware_set_recording(void *context, bool recording);
void agent_hub_firmware_button(void *context, bool side_button, int32_t clicks);
void agent_hub_firmware_set_orientation(void *context, bool landscape, bool landscape_reverse);
AgentHubFirmwareSnapshot agent_hub_firmware_snapshot(void *context);
const uint16_t *agent_hub_firmware_framebuffer(void *context);
uint32_t agent_hub_firmware_frame_serial(void *context);
int32_t agent_hub_firmware_frame_width(void *context);
int32_t agent_hub_firmware_frame_height(void *context);
int32_t agent_hub_firmware_active_provider(void *context);
bool agent_hub_firmware_selector_active(void *context);
